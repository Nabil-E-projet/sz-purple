    ...
    def get(self, request, payslip_id):
        ...
        try:
            ...
            return Response({
                ...
                "filename": (payslip.original_filename or (payslip.uploaded_file.name.split('/')[-1] if payslip.uploaded_file else None)),
                "file_deleted": getattr(payslip, 'file_deleted', False),
